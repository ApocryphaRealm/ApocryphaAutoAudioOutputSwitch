...
NEW = {
    "japanese": {
        "AAIS_Status": "状態",
        "AAIS_StatusInvalidated": "出力デバイスが使えなくなりました。接続されている別のデバイスに切り替えています...",
    ...
    "korean": {
        "AAIS_Status": "상태",
        "AAIS_StatusInvalidated": "출력 장치가 작동을 멈췄습니다. 연결된 다른 장치로 전환하는 중...",
    ...
    "chinese": {
        "AAIS_Status": "状态",
        "AAIS_StatusInvalidated": "输出设备已停止工作。正在切换到另一个已连接的设备...",
    ...
    "russian": {
        ...
        "AAIS_StatusInvalidated": "Устройство вывода перестало работать. Переключение на другое подключённое устройство...",
    ...
    "german": {
        "AAIS_Status": "Status",
        "AAIS_StatusInvalidated": "Das Ausgabegerät funktioniert nicht mehr. Wechsel zu einem anderen verbundenen Gerät...",
    ...
    "french": {
        "AAIS_Status": "État",
        "AAIS_StatusInvalidated": "Le périphérique de sortie a cessé de fonctionner. Bascule vers un autre périphérique connecté...",
    ...
    "spanish": {
        "AAIS_Status": "Estado",
        "AAIS_StatusInvalidated": "El dispositivo de salida dejó de funcionar. Cambiando a otro dispositivo conectado...",
    ...
    "italian": {
        "AAIS_Status": "Stato",
        "AAIS_StatusInvalidated": "Il dispositivo di uscita ha smesso di funzionare. Passaggio a un altro dispositivo collegato...",
    ...
    "polish": {
        "AAIS_Status": "Stan",
        "AAIS_StatusInvalidated": "Urządzenie wyjściowe przestało działać. Przełączanie na inne podłączone urządzenie...",
    ...
    "czech": {
        "AAIS_Status": "Stav",
        "AAIS_StatusInvalidated": "Výstupní zařízení přestalo fungovat. Přepínání na jiné připojené zařízení...",
